...
console.log(classPhotos([5, 8, 1, 3, 4], [6, 9, 2, 4, 5])); // t
console.log(classPhotos([6, 9, 2, 4, 5], [5, 8, 1, 3, 4])); // t
console.log(classPhotos([6, 9, 2, 4, 5, 1], [5, 8, 1, 3, 4, 9])); // f
console.log(classPhotos([6], [6])); // f
console.log(classPhotos([126], [125])); // t
console.log(classPhotos([1, 2, 3, 4, 5], [2, 3, 4, 5, 6])); // t
console.log(classPhotos([1, 1, 1, 1, 1, 1, 1, 1], [5, 6, 7, 2, 3, 1, 2, 3])); // f
